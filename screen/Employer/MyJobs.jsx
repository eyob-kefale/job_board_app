...
const MyJobs = ({ route, navigation }) => {
    ...
    const userProfileCollectionRef = query(collection(db, 'user'), where('email', '==', userEmail));
    ...
    const postCollectionRef = query(collection(db, 'jobLists'), where('employer', '==', userEmail));
    ...
    const addJob = () => {
        navigation.navigate("CreateJobListing")
    }
